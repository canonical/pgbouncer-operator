...
async def test_build_and_deploy_current(ops_test: OpsTest):
    ...
    logger.info(ops_test.model.applications[APP_NAME])
    logger.info(dir(ops_test.model.applications[APP_NAME]))
    logger.info(ops_test.model.applications[APP_NAME].status)
    logger.info(ops_test.model.units[f"{APP_NAME}/0"])
    logger.info(ops_test.model.units[f"{APP_NAME}/0"].agent_status)
    logger.info(ops_test.model.units[f"{APP_NAME}/0"].agent_status_message)
    logger.info(ops_test.model.units[f"{APP_NAME}/0"].workload_status)
    logger.info(ops_test.model.units[f"{APP_NAME}/0"].workload_status_message)
    logger.info(dir(ops_test.model.units[f"{APP_NAME}/0"]))
    assert (
