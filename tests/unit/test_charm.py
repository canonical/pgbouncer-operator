...
class TestCharm(unittest.TestCase):
    ...
    def test_on_install(
        ...
        _mkdir.assert_any_call(PGB_DIR, 0o600)
        _chown.assert_any_call(PGB_DIR, 1100, 120)

        for service_id in self.charm.service_ids:
            _mkdir.assert_any_call(f"{PGB_DIR}/instance_{service_id}", 0o600)
    ...
    def test_render_service_configs(self, _render, _reload):
        ...
        _render.assert_any_call(INI_PATH, cfg_list[0], 0o600)
        _render.assert_any_call(f"{PGB_DIR}/instance_0/pgbouncer.ini", cfg_list[1], 0o600)
        _render.assert_any_call(f"{PGB_DIR}/instance_1/pgbouncer.ini", cfg_list[2], 0o600)
